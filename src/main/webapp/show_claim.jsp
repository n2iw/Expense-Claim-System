...
<div class="container">
	<fieldset>
		...
		<img src="receipt.jpg" class="img-thumbnail" alt="Food Receipt"
			width="304" height="236"> <img src="receipt2.jpg"
			class="img-thumbnail" alt="Food Receipt" width="304" height="236">
