...
<div class="container">
	...
	<form class="form-horizontal" action="#" method="post"
		...
		<div class="form-group">
			<div class="col-sm-6">
				<a class="btn btn-primary form-control" href="add_trip.jsp"
					role="button">Add Trip</a>
			</div>
			<div class="col-sm-6">
				<a class="btn btn-primary form-control" href="employee_form.jsp"
					role="button">Add Expense Claim</a>
			</div>
		</div>
	</form>
	<form class="form-horizontal" action="#" method="post"
